...
# Created: Mon Dec 14 15:01:49 PST 2015
#
#/ usage: rundeck-project:delete  --project <>  --url <$RUNDECK_URL>  --username <$RUNDECK_USER> [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>]  --yes-really|-y 
