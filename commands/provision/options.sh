...
# Created: Mon Dec 14 10:41:58 PST 2015
#
#/ usage: rundeck-project:provision  --project <>  --templates <>  --url <$RUNDECK_URL>  --username <$RUNDECK_USER>  --password <$RUNDECK_PASSWORD>  --rdeck-base <$RDECK_BASE>  --git-repo-url <> 
