...
#
#/ usage: rundeck-project:provision  --project <>  --templates <>  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>]  --rdeck-base <$RDECK_BASE>  --git-repo-url <> --group <>
