...
# Created: Thu Dec 10 20:38:49 PST 2015
#
#/ usage: rundeck-project:scm-setup  --project <> [ --file <>]  --url <$RUNDECK_URL>  --username <$RUNDECK_USER>  --password <$RUNDECK_PASSWORD>  --scm-integration <>  --action <get> 
