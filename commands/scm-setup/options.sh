...
# Created: Mon Dec 14 15:01:52 PST 2015
#
#/ usage: rundeck-project:scm-setup  --project <> [ --file <>]  --url <$RUNDECK_URL>  --username <$RUNDECK_USER> [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>]  --scm-integration <>  --action <get> 
...
rerun_options_parse() {
    ...
    [ -z "$SCM_INTEGRATION" ] && { echo >&2 "missing required option: --scm-integration" ; return 2 ; }
