...
# Created: Thu Dec 10 16:30:57 PST 2015
#
#/ usage: rundeck-project:create  --url <$RUNDECK_URL>  --username <$RUNDECK_USER>  --password <$RUNDECK_PASSWORD>  --project <>  --templates <> [ --description <>] 
