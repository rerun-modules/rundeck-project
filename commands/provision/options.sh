...
# Created: Wed Dec 23 11:44:15 PST 2015
#
#/ usage: rundeck-project:provision  --project <>  --templates <>  --rdeck-base <${RDECK_BASE:-}> [ --git-repo-url <>]  --url <${RUNDECK_URL:-}> [ --username <${RUNDECK_USER:-}>] [ --password <${RUNDECK_PASSWORD:-}>] [ --apikey <${RUNDECK_APIKEY:-}>] 
...
rerun_options_parse() {
    ...
    [[ -z "$RDECK_BASE" ]] && RDECK_BASE="$(rerun_property_get $RERUN_MODULE_DIR/options/rdeck-base DEFAULT)"
