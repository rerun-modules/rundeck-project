...
# Created: Mon Dec 14 15:01:45 PST 2015
#
#/ usage: rundeck-project:acls-delete [ --aclpolicy <>]  --project <>  --url <$RUNDECK_URL>  --username <$RUNDECK_USER> [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>] 
